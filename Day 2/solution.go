...
func solve(meal_cost float64, tip_percent int32, tax_percent int32) {
    // can't use operation between different type: int, int32, float64...
    var price100 float64 = meal_cost * float64( 100 + tip_percent + tax_percent );
    fmt.Println( math.Round( price100 / 100.0 ) );
